      ...
      <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-glass border border-white p-1">
        <div className="bg-white rounded-[20px] p-8 sm:p-10 shadow-sm">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-ink-900 mb-3 tracking-tight">Welcome Back</h2>
            <p className="text-ink-500 text-sm font-medium">Enter your credentials to access your dashboard.</p>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-ink-500 font-medium">
              ...
              <Link href="/signup" className="text-brand-600 hover:text-brand-700 font-bold hover:underline decoration-2 underline-offset-2">
                Sign up
              </Link>
            </p>
          </div>
